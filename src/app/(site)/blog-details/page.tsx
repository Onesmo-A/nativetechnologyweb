...
export const metadata: Metadata = {
  title: "Blog Post | Native Technology",
  description: "Read the latest insights and updates from Native Technology.",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  Designing Products That Feel Premium in Light &amp; Dark Mode
                </h2>
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="text-body-color mb-1 text-base font-medium">
                          By <span>Native Technology</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    A premium product experience is not only about visuals—it’s
                    also about clarity, accessibility, and consistency. Here’s
                    how we approach design so every screen feels great in both
                    light and dark mode.
                  </p>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Start with a small set of design tokens (colors, spacing,
                    typography) and reuse them everywhere. When the foundation is
                    token-driven, switching themes becomes predictable and your
                    UI stays{" "}
                    <strong className="text-primary dark:text-white">
                      consistent
                    </strong>{" "}
                    across pages, components, and platforms.
                  </p>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Next, validate contrast and states (hover, focus, disabled)
                    for every key component. A theme is only as good as its
                    edge-cases—forms, cards, and tables are where quality shows.
                  </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    If you’re building a brand-new product or modernizing an
                    existing system, this checklist helps you keep the UI clean,
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Define tokens for background, surface, text, and borders.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Check contrast for body text and secondary text.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Ensure focus rings are visible in both themes.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Use shadows and borders intentionally (avoid muddy surfaces).
                    </li>
                  </ul>
                  <div className="bg-primary/[0.03] border-l-4 border-primary relative z-10 mb-10 overflow-hidden rounded-sm p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-black dark:text-white text-center text-lg font-semibold italic italic">
                      A great theme isn’t “dark” or “light”—it’s a system that
                      stays consistent under every condition.
                    </p>
