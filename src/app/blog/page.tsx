...
export const metadata: Metadata = {
  title: "Blog | Native Technology",
  description:
    "Articles and updates on product design, development, maintenance, and digital solutions by Native Technology.",
  // other metadata
};
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Blog"
        description="Insights and updates from the Native Technology team."
      />
